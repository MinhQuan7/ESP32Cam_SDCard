...
int IncludeInternet = 2;      // 0 for no internet, 1 for time only, 2  WiFiMan, 3 ssid in file, 4 ssid in file default off, 5 host mode

const char* ssid = "eoh.io";

// https://sites.google.com/a/usapiens.com/opnode/time-zones  -- find your timezone here
// String TIMEZONE = "GMT0BST,M3.5.0/01,M10.5.0/02";
String TIMEZONE = "CST-7";
...
//___________________________________________________Read Config File_____________________________________________________
